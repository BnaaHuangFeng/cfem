...
int main(int argc,char **argv){
    ...
    */
    ...
    MessagePrinter::printTxt("verification of parse Rank2Tensor2d 2 Rank2Tensor3d (if vector<double> a deep copy)",MessageColor::YELLOW);
    Rank2Tensor2d rank2Tensor2d(Rank2Tensor2d::InitMethod::RANDOM);
    Rank2Tensor3d rank2Tensor3d=rank2Tensor2d.toRank2Tensor3d();
    ...
    Rank2Tensor3d R23=VR22.toRank2Tensor3d();
    ...
    MessagePrinter::printTxt("verification of parse ViogtRank4Tensor2D 2 Rank4Tensor3d (if vector<double> a deep copy)",MessageColor::YELLOW);
    ViogtRank4Tensor2D VR42(ViogtRank4Tensor2D::InitMethod::RANDOM);
    Rank4Tensor3d R43=VR42.toRank4Tensor();
    MessagePrinter::printTxt("the original ViogtRank4Tensor2D:");
    VR42.print();
    MessagePrinter::printTxt("ViogtRank4Tensor2D parsed Rank4Tensor3d:");
    ...
    Rank2Tensor3d L2=L.toRank2Tensor3d();
